...
const Tools = ({ setToolText }) => {
  ...
  const toolTexts = {
    ...
    react:
      "I was introduced to react during university about 3-4 years ago but I've recently gained a new appreciation for the framework. React and React hooks make for quick prototyping with production level reactivity and features. Being able to use OOP and componetize everything in my code allows me to write clean and reusable code",
    nodejs:
    ...
    nextjs:
      "NextJS is a new technology to me that I have quickly grown to love. The framework does a lot of heavy lifting for you in terms of routing and overall app management. I would highly reccomend using NextJS in your projects if you're familiar with React",
    vscode:
