...
const Awards = () => {
  const awards = [
    ...
    },
    {
      ...
      date: "2017-2020",
      description:
        "By maintaining above a 3.0 GPA at Eastern Kentucky University I received the Dean's List honor for all of my semesters I attended. The majority of my semesters I received a 4.0 GPA in all courses and received the Presidents award 5 times.",
      icon: GiAchievement,
    },
    {
